//==============================================================
// A5Q1MardirosXian.java
//
// COMP 2140 FALL 2019
// ASSIGNMENT 5 Question 1
// Updated by: Xian Mardiros
//
...
//==========================================================
// A5Q1MardirosXian class (application class)
//==========================================================

public class A5Q1MardirosXian{
...
class BookTree {
    ...
    //System.out.println( "inserting " + newItem.toString() );
	if ( root == null ) {
    ...
    //System.out.println( "inserting: " + newItem.getAuthor() + ", below: " + fred.toString() );
	int authorComparison = newItem.getAuthor().compareTo( fred.item.getAuthor() );
    //System.out.println( "author diff: " + authorComparison );
     ...
     *
     ******************************************************************/
    public String searchByAuthor( String searchAuthor ) {
        BSTNode curr = root;
        boolean firstItem = true;

        String matchingBooks = "";
        while ( curr != null ) {
            //System.out.println( "Searching at: " + curr.item );
            if ( searchAuthor.compareTo( curr.item.getAuthor() ) == 0 ) {
                if ( !firstItem ) {
                ...
                curr = curr.right;
            } else if ( searchAuthor.compareTo(curr.item.getAuthor() ) < 0 ) {
                curr = curr.left;
            } else {
                curr = curr.right;
            } // end if-else-if-else
    ...
    public String searchByTitle( String searchTitle ) {
        String matchingBooks = "";
        if ( root != null ) {
            matchingBooks += searchByTitle( root, searchTitle );
        } // end if
        return matchingBooks;
    ...
    if( curr.left == null ){
        ...
        inorderSucc = deleteSuccessor( currParent, curr.left );
    }
